      ...
      text: async ({
        ...
        if (type !== "text") {
          logger
            .forBot()
            .warn(
              "[HITL Channel - text msg] Received a non-text message, skipping Brevo send. Type:",
              type,
            );
          return;
        }
        ...
        logger
          .forBot()
          .info(`[HITL Channel - text msg] Text payload: "${text}"`);
        ...
        logger
          .forBot()
          .info(
            `[HITL Channel - text msg] Attempting to send message to Brevo. VisitorID (brevoConversationId): ${brevoConversationId}, Text: "${text}"`,
          );
