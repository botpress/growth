...
export const createContactInputSchema = z.object({
  properties: z
    .string()
    .describe("Properties of the contact to create, as a string JSON object."),
});
...
export const updateContactInputSchema = z.object({
  ...
  properties: z
    .string()
    .describe("Properties of the contact to update, as a string JSON object."),
});
...
export const upsertContactInputSchema = z.object({
  properties: z
    .string()
    .describe("Properties of the contact to upsert, as a string JSON object."),
});
...
export const getContactsByBusinessIdInputSchema = z.object({
  businessId: z
    .string()
    .describe("ID of the business whose contacts are to be retrieved"),
  params: z
    .string()
    .optional()
    .describe("Optional query parameters as a string JSON object."),
});
...
export const makeApiCallInputSchema = z.object({
  ...
  data: z
    .string()
    .optional()
    .describe("The data to send with the request as a string JSON object."),
  params: z
    .string()
    .optional()
    .describe(
