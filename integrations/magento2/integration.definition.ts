...
export default new IntegrationDefinition({
  ...
  configuration: {
    schema: z.object({
      magento_domain: z
        .string()
        .describe(
          "The domain of the Magento instance (example www.test-domain.com)",
        ),
      ...
      user_agent: z
        .string()
        .optional()
        .describe("The User Agent to use for the request"),
      botpress_pat: z
        .string()
        .describe("Botpress Personal Access Token (PAT) for Tables API access"),
    }),
  },
  actions: {
    getProducts: {
      ...
      input: {
        schema: z.object({
          searchCriteria: z
            .string()
            .optional()
            .describe("The search criteria to use for the request"),
        }),
      },
      output: {
        schema: z.object({
    ...
    getStockItem: {
      ...
      input: {
        schema: z.object({
          sku: z
            .string()
            .describe("The SKU of the product to get stock information for"),
        }),
      },
      output: {
        schema: z.object({
          ...
          error: z
            .string()
            .optional()
            .describe("Error message if request failed"),
        }),
      },
    },
    syncProducts: {
      ...
      input: {
        schema: z.object({
          ...
          _totalCount: z
            .number()
            .optional()
            .describe("Total number of products"),
          _tableId: z.string().optional().describe("ID of the Botpress table"),
          _runId: z.string().optional().describe("Sync run ID"),
          _customAttributeCodes: z
            .array(z.string())
            .optional()
            .describe("Custom attribute codes"),
          _attributeMappings: z
            .string()
            .optional()
            .describe("Attribute mappings as a JSON string"),
          _filterCriteria: z
            .string()
            .optional()
            .describe("Filter criteria string"),
          _currentPageProductIndex: z
            .number()
            .optional()
            .describe("Current product index within the page"),
        }),
      },
      output: {
        schema: z.object({
          ...
          table_name: z
            .string()
            .describe("Name of the table products were synced to"),
  ...
  events: {
    magentoSyncContinue: {
      ...
      description:
        "Triggered to continue syncing products from Magento in batches",
      schema: z.object({
        table_name: z
          .string()
          .describe("Name of the Botpress table to sync products to"),
        custom_attributes: z
          .string()
          .optional()
          .describe(
            "Comma-separated list of custom product attributes to sync",
          ),
        filters_json: z
          .string()
          .optional()
          .describe("JSON array of filter objects"),
        _currentPage: z.number().optional().describe("Current page number"),
