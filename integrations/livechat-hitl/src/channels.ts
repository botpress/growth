  ...
  hitl: {
    messages: {
      text: async ({ client, ctx, conversation, logger, ...props }: bp.AnyMessageProps) => {
        ...
        const livechatTokenPayload = accessTokenState.state.payload as unknown as LivechatTokenPayload
        ...
        return await liveChatClient.sendMessage(liveChatConversationId, userMessage, customerAccessToken)
      },
    },
  },
