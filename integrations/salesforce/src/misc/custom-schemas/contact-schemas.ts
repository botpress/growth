...
export const CreateContactInputSchema = z.object({
  ...
  Email: z.string().email().describe('The email address of the contact (e.g. john.doe@example.com)'),
...
export const SearchContactsInputSchema = z.object({
  ...
  Name: z.string().optional().describe('The first name of the contact (e.g. John)'),
  Email: z.string().email().optional().describe('The email address of the contact (e.g. john.doe@example.com)'),
})
